...
class Strings {
  ...
  static final String jsonUrl =
      "https://raw.githubusercontent.com/Hakim-Allaoui/guideTemplate/qooapp/assets/config.json";
  ...
  static final String privacyText = """
    ...
    <ul> <li>To facilitate our Service;</li> <li>To provide the Service on our behalf;</li> <li>To perform Service-related services; or</li> <li>To assist us in analyzing how our Service is used.</li>
    </ul>
